...
# Print the dimensions of the original and cleaned dataframes
cat("Original dataframe dimensions:", nrow(merged_df_new), "\n")
cat("Cleaned dataframe dimensions:", nrow(merged_df_clean), "\n")
cat("Total rows removed:", nrow(merged_df) - nrow(merged_df_clean), "\n")
